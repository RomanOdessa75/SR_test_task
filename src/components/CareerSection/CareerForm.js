		...
		>
			...
			<div className="sm:w-[221px] flex flex-col">
				...
				<div className="flex flex-row gap-[4px] top-[16px] relative mb-[16px] sm:absolute sm:top-[355px] sm:left-[-5px] sm:w-[222px] sm:top-[357px] sm:mb-[0] md:top-[418px] md:w-[258px]">
					...
					></input>
					<CheckBox
						className={"checkbox-icon fill-white opacity-10 absolute top-[5px] left-[5px]"}
						width={14}
						height={14}
					/>
				...
				<button
					className="self-end uppercase text-[30px] font-medium leading-[36px] text-end sm:flex sm:ml-[auto] md:mr-[-70px]"
					type="submit"
				>
					Send
				</button>
