...
export default function HeroSectionContent() {
	return (
		<div className="container z-[1] max-w-[280px] md:max-w-[1280px] sm:max-w-[704px] md:gap-[281px] md:px-[24px] flex flex-col relative pt-[76px] pb-[56px] sm:mt-[0] mt-[36px] mx-[auto] mb-[0] sm:flex-row sm:gap-[48px] sm:pt-[66px] sm:pb-[64px] md:pt-[72px] md:pb-[104px]">
			...
			<div className="order-[0] md:flex md:flex-col md:justify-between">
				<h2 className="flex flex-col  sm:relative absolute top-[0] right-[0] items-end uppercase text-white text-[37px]">
					<span className="relative">
						<span className="font-bold text-[37px] sm:text-[67px] md:text-[98px]">7</span>
