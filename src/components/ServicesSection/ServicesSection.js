...
export default function ServicesSection() {
	...
	return (
		<section
			className="services-section w-[100%] max-w-[100%] h-[851px]  sm:h-[621px] md:h-[779px] bg-cover bg-no-repeat"
			id="services"
			style={{
		...
		>
			<div className="div relative bg-bgColor w-[100%] h-[100%]">
				<div className="container sm:flex-col text-white h-[100%] max-w-[280px] sm:max-w-[704px] md:max-w-[1280px] md:gap-[23px] md:px-[15px] flex flex-col relative pt-[54px] sm:mt-[0] sm:pt-[64px] md:pt-[80px] mx-[auto] mb-[0] sm:flex-row sm:gap-[36px] sm:pt-[66px]">
